...
const ChatApp = () => {
  ...
  return (
    <div className={styles.chatApp}>
      ...
      />
      <ChatWindow chat={selectedFriendData || { messages: [] }} sessionName={sessionName} />
    </div>
  );
};
